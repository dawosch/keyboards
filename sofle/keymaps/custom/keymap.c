...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_CNRY] = LAYOUT(
        ...
        KC_LALT, DE_Q, DE_J, DE_V, DE_D, DE_K, TG(_STP),                            DF(_QWRTZ), DE_X, DE_H, DE_SS, DE_COMM, DE_DOT, KC_RALT,
                KC_LALT, KC_LGUI, MO(_NMPD), MO(_SYMBLS), LCTL_T(KC_SPC),            KC_ENT, MO(_NVGTN), KC_NO, KC_NO, KC_NO),
    ...
    [_NVGTN] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                       KC_NO, KC_PGUP, KC_HOME, KC_NO, KC_NO, KC_NO,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                     KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_NO, KC_NO,
        KC_LALT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                          KC_NO, KC_NO, KC_PGDN, KC_END, KC_NO, KC_NO, KC_NO,
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
